...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... para) {
            ...
            String location = para[0];
            URL weatherRequest = NetworkUtils.buildUrl(location);

            try {
                String jsonWeatherResp = NetworkUtils.getResponseFromHttpUrl(weatherRequest);

                String[] simpleJsonWeather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherResp);
